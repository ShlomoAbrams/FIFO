...
\pandocbounded{\includegraphics[keepaspectratio,alt={FIFO queue}]{fifo_queue.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={FIFO Architecture}]{FIFO_Block_Diagram.jpg}}
...
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio,alt={Before Edge}]{Before_Edge.png}}
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio,alt={After Edge}]{After_Edge.png}}
\item
  ...
  process variations.\\
  \pandocbounded{\includegraphics[keepaspectratio,alt={Metastable state}]{Metastable_state.jpeg}}
\item
...
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio,alt={Setup Time Violation}]{Setup_Time.jpeg}}
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio,alt={Hold Time Violation}]{Hold_Time.jpeg}}
\end{enumerate}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={2FF Synchronizer Architecture}]{Gray_Pointer_Syncronizer.jpeg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={UVM Testbench Architecture}]{UVM_Architecture.jpeg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={UVM Logistics Analogy}]{uvm_logistics_analogy.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={SVA \& Coverage Diagram}]{sva_&_coverage.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Coverage Report Summary}]{coverage.png}}

\subsubsection{Detailed Design Units Coverage
Breakdown}\label{detailed-design-units-coverage-breakdown}

\pandocbounded{\includegraphics[keepaspectratio,alt={Detailed Design Units Coverage}]{coverage_details.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Waveform Simulation}]{Waveform_Simulation.png}}

\section{Waveforms Colors Match Diagram
Signals}\label{waveforms-colors-match-diagram-signals}

\pandocbounded{\includegraphics[keepaspectratio,alt={FIFO Block Diagram}]{FIFO_Block_Diagram_Black.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Read \& Write Waveform}]{read_&_write_waveform.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={FIFO Full Waveform}]{wfull_waveform.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={FIFO Empty Waveform}]{rempty_waveform.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Read to Write Sync}]{r2w_sync_waveform.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Write to Read Sync}]{w2r_sync_waveform.png}}
